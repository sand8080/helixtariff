...
class DomainPriceTestCase(ServiceTestCase):
    ...
    def setUp(self):
        ...
        self.add_to_service_set(self.service_set_descr_name, [self.service_type_name])
    ...
    def test_get_price(self):
        ...
        data = {
            'login': self.test_client_login,
            'tariff_name': self.tariff_name + 'fake',
            'service_type_name': self.service_type_name,
        }
        ...
        data = {
            'login': self.test_client_login,
            'tariff_name': self.tariff_name,
            'service_type_name': self.service_type_name + 'fake',
        }
        self.assertRaises(EmptyResultSetError, handle_action, 'get_domain_service_price', data)
